...
func testLetStatement(t *testing.T, s ast.Statement, name string) bool {
	...
	if s.TokenLiteral() != "let" {
		t.Errorf("s.TokenLiteral node 'let', got=%q", s.TokenLiteral())
		return false
	}
...
func TestReturnStatements(t *testing.T) {
	...
	for _, tt := range tests {
		...
		if len(program.Statements) != 1 {
			t.Fatalf("program.Statesments does not contain 1 statements. got=%d", len(program.Statements))
		}
...
func TestParserPrefixExpressions(t *testing.T) {
	prefixTests := []struct {
		input    string
		operator string
		value    interface{}
...
func testIdentifier(t *testing.T, exp ast.Expression, value string) bool {
	...
	if !ok {
		t.Errorf("exp not *ast.Identifier. got=%T, got=%s", exp, exp.TokenLiteral())
		return false
	}
...
func TestParserInfixExpressions(t *testing.T) {
	...
	for _, tt := range infixTests {
		...
		if len(program.Statements) != 1 {
			t.Fatalf("program.Statesment does not contain %d statements. got=%d", 1, len(program.Statements))
		}
...
func TestParsingArrayLiteral(t *testing.T) {
	...
	if len(array.Elements) != 3 {
		t.Fatalf("len(array.Elements) not 3. gpt=%d", len(array.Elements))
	}
...
func TestParsingHashLiteralsIntegerKeys(t *testing.T) {
	...
	for key, value := range hash.Pairs {
		...
		expectedValue := expected[integer.Value]
